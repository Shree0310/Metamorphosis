            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid gap-6 md:grid-cols-2">
                <label className="text-sm font-semibold text-[#2B2420]">
                  ...
                  <input
                    ...
                    className="w-full border border-[#E7DCCF] bg-[#FFFDF9] px-4 py-3 outline-none focus:border-[#FF6F81]"
              ...
              <label className="block text-sm font-semibold text-[#2B2420]">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full resize-y border border-[#E7DCCF] bg-[#FFFDF9] px-4 py-3 outline-none focus:border-[#FF6F81]"
                  placeholder="Share a little about what brought you here."
                />
              </label>

              <button
                type="submit"
                className="rounded-full bg-[#FF6F81] px-7 py-3 text-sm font-semibold text-[#FFFBF2] transition hover:bg-[#C2445B]"
              >
                Send enquiry
              </button>
            ...
            <div className="rounded-[2rem] border border-[#FDE68A] bg-[#FDEEEF] p-8">
              ...
              <div className="mt-5 space-y-4">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="block rounded-2xl border border-[#E7DCCF] bg-white p-4 text-[#2B2420] transition hover:border-[#FF6F81] hover:shadow-sm"
                >
                  <p className="font-semibold" style={{ fontFamily: 'var(--font-baloo)' }}>
                    Individual Therapy
                  </p>
